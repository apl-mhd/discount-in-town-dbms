        ...
        <div class="col-md-9 maincontent">
            <div class="row"> <!--start row-->
                ...
                $searchArr = array('burger' => 'food', 'pizza' => 'food',
                    'kacchi' => 'food','fried chicken' => 'food', 'chicken' => 'food',
                    'head phone' => 'mobileacc','ram' => 'computeracc', 'mouse'=> 'computeracc',
                    'laptop' =>'computer', 'desktop'=>'computer','bike'=>'motorcycle','motorcycle'=>'motorcycle'
               ...
               // print_r($searchArr);
                ...
                SELECT category.id 
                   FROM category
                     WHERE category.subcategory = '$search')";
               ...
               // print_r($row);
                ...
                <div class="thumbnail thumb">'
                        ...
                        . '
                    <img style="height:400px;" class="img" src="img/'. $img . '">'.'
