...
/*
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-2" style="padding-top: 40px">
            ...
            <form action="comentinsert.php" method="post">
    ...
    <?php
        ...
        if (isset($_POST)) {
            ...
            if (isset($_SESSION['userid'])) {
                ...
                $sql = "INSERT INTO comment( comment,postid) VALUES
                ('$comment', $postid)";

            } else {

                /*            $sql = "INSERT INTO comment( comment, email, userid) VALUES
                                ($comment, $email,$userid)";*/
